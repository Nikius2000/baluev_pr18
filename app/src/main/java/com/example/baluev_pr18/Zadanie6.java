...
public class Zadanie6 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zadanie6);
        ...
        String[] groupFrom = { DB_zd6.COMPANY_COLUMN_NAME };
        int[] groupTo = { android.R.id.text1 };
        // сопоставление данных и View для элементов
        String[] childFrom = { DB_zd6.PHONE_COLUMN_NAME };
    ...
    class MyAdapter extends SimpleCursorTreeAdapter {
        ...
        protected Cursor getChildrenCursor(Cursor groupCursor) {
            ...
            int idColumn = groupCursor.getColumnIndex(DB_zd6.COMPANY_COLUMN_ID);
